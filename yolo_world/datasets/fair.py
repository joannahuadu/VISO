...
class FAIRDataset(BaseDataset):
    """FAIR-v1.0/v2.0 dataset for detection.

    Note: ``ann_file`` in FAIRDataset is different from the BaseDataset.
    In BaseDataset, it is the path of an annotation file. In FAIRDataset,
    ...
    METAINFO = {
        'classes':
            ('ship/tugboat', 'ship/passenger-ship', 'vehicle/small-car', 'vehicle/dump-truck', 'vehicle/van',
