_base_ = '../rtmdet-r_l_syncbn_fast_2xb4-aug-100e_dota.py'
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='/mnt/data1/workspace/wmq/YOLO-World/work_dirs/rtmdet-r_l_syncbn_fast_2xb4-aug-100e_dota/20240710_142940/Task1')
