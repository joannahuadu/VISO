_base_ = (
    '../yolo_world_sp_v2_l_vlpan_bn_2e-4_80e_8gpus_mask-refine_finetune_dota.py')
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='work_dirs/yolo_world_sp_v2_l_vlpan_bn_2e-4_80e_8gpus_mask-refine_finetune_dota_trainval/20240801_113311/Task1')
