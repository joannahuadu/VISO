...
score_th = 0.9
embedding_path = "/mnt/data1/workspace/wmq/YOLO-World/tools/embeddings/dota_v2_class_texts_helicopter_embedding_ywspl.npy"
...
dota_test_dataset = dict(
    ...
    dataset=dict(
        ...
        data_root='/mnt/data1/workspace/wmq/YOLO-World/data/dotav2_helicopter/',
        test_mode=True,
...
work_dir = 'appendix_work_dirs/dota_helicopter'
