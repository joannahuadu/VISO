...
score_th = 0
embedding_path = "/mnt/data1/workspace/wmq/YOLO-World/tools/embeddings/dota_v2_class_texts_all_embedding_ywspl.npy"
...
dota_test_dataset = dict(
    ...
    dataset=dict(
        ...
        data_root='/mnt/data1/workspace/wmq/YOLO-World/data/dotav2_all_not/',
        test_mode=True,
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='/mnt/data1/workspace/wmq/YOLO-World/work_dirs/yolo_world_sp_l_vlpan_bn_2e-4_100e_4x8gpus_dotav2_ft_trainval_bcelossattn/test/')
...
work_dir = 'appendix_work_dirs/dota_all'
