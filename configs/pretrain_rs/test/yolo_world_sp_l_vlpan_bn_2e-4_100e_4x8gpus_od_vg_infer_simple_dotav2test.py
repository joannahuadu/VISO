...
score_th = 0
embedding_path = "/mnt/data1/workspace/wmq/YOLO-World/tools/embeddings/dota_v2_class_texts_all_embedding_ywspl_alpha10.npy"
load_from = "/mnt/data1/workspace/wmq/YOLO-World/work_dirs/yolo_world_sp_l_vlpan_bn_2e-4_100e_4x8gpus_od_vg_train_dotaval_bcelossattn/alpha10/epoch_14.pth"
# model settings
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='/mnt/data1/workspace/wmq/YOLO-World/work_dirs/yolo_world_sp_l_vlpan_bn_2e-4_100e_4x8gpus_od_vg_train_dotaval_bcelossattn/trainval/epoch14/0515/a10/Task1')
