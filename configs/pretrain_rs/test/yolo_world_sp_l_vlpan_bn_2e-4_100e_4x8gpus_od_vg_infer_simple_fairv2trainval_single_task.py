...
score_th = 0.9
embedding_path = "/mnt/data1/workspace/wmq/YOLO-World/tools/embeddings/fair_v2_class_texts_ship_embedding_ywspl.npy"
...
class_text_path = "/mnt/data1/workspace/wmq/YOLO-World/data/texts/ship.json"
# model settings
