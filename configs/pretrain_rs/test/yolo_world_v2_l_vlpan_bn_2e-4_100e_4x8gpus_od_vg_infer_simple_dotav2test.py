...
num_classes = 18
embedding_path = "tools/embeddings/dota_v2_class_texts_all_embedding_ywl.npy"
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='/mnt/data1/workspace/wmq/YOLO-World/work_dirs/yolo_world_v2_l_vlpan_bn_2e-3_100e_4x8gpus_od_vg_train_1280ft_dotaval/trainval_simple/prompts/Task1')
