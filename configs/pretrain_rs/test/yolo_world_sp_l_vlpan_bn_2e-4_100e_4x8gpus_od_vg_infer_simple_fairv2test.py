...
score_th = 0
embedding_path = "/mnt/data1/workspace/wmq/YOLO-World/tools/embeddings/fair_v2_class_texts_all_embedding_ywspl.npy"
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix=f'/mnt/data1/workspace/wmq/YOLO-World/work_dirs/yolo_world_sp_l_vlpan_bn_2e-4_100e_4x8gpus_dotav2_ft_trainval_bcelossattn/fairv2/ep29/nosimple/{is_sparse_levels[0]}{is_sparse_levels[1]}{is_sparse_levels[2]}_{score_th}/test')
