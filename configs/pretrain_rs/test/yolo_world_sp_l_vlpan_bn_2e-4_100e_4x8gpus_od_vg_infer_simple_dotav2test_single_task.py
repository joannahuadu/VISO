...
score_th = 0.2
classtype = 'plane'
embedding_path = f"/mnt/data1/workspace/wmq/YOLO-World/tools/embeddings/dota_v2_class_texts_{classtype}_embedding_ywspl.npy"
...
class_text_path = f"/mnt/data1/workspace/wmq/YOLO-World/data/texts/dota_v1_class_texts_{classtype}.json"
# model settings
# _base_.model.test_cfg.score_thr = 0.1
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix=f'/mnt/data1/workspace/wmq/YOLO-World/work_dirs/yolo_world_sp_l_vlpan_bn_2e-4_100e_4x8gpus_od_vg_train_dotaval_bcelossattn/trainval/epoch14/{classtype}/111_02/Task1')
