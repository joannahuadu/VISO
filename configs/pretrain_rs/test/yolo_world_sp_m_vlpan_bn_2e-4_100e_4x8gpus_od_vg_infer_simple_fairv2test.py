...
score_th = 0.9
embedding_path = "/mnt/data1/workspace/wmq/YOLO-World/tools/embeddings/fair_v2_class_texts_all_embedding_ywspm.npy"
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix=f'/mnt/data1/workspace/wmq/YOLO-World/work_dirs/yolo_world_sp_m_vlpan_bn_2e-4_100e_4x8gpus_od_vg_train_dotaval_bcelossattn/trainval/fairv2/ep14/{is_sparse_levels[0]}{is_sparse_levels[1]}{is_sparse_levels[2]}_{score_th}/simple/test')
