_base_ = (
    '../yolo_world_v2_x_vlpan_bn_2e-3_80e_8gpus_mask-refine_finetune_dota.py')
...
test_evaluator = dict(
    ...
    format_only=True,
    merge_patches=True,
    outfile_prefix='/mnt/data1/workspace/wmq/YOLO-World/work_dirs/yolo_world_v2_x_vlpan_bn_2e-3_80e_8gpus_mask-refine_finetune_dota/dota/Task1')
